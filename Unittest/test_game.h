...
private:
    ...
    //If you add more unit test classes, these methods should be moved to a abstract base class
    bool content_is_equal(const std::vector<int>& expected, const std::vector<int>& actual);
    bool content_is_not_equal(const std::vector<int>& expected, const std::vector<int>& actual);
    void print(const std::string& message,const std::vector<int>& expected, const std::vector<int>& actual);
